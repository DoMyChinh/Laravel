			...
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="col-md-8">
						...
						?>
						<form role="form" method="post" action="index.php?c=user&a=update&id=<?php echo $data['users_id']; ?>">
							...
							<?php if(isset($_SESSION['err_update']['user_full'])) 
									{ 
							...
							<?php if(isset($_SESSION['err_update']['user_mail'])) 
								  {
